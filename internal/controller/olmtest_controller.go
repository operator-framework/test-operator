...
// OLMTestReconciler reconciles a OLMTest object
type OLMTestReconciler struct {
	client.Client
...
// the OLMTest object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.20.4/pkg/reconcile
func (r *OLMTestReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *OLMTestReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&testolmoperatorframeworkiov1.OLMTest{}).
		Named("olmtest").
		Complete(r)
}
